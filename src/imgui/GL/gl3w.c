...
#ifdef _MSC_VER
    #pragma warning(disable : 4055) // warning C4055: 'type cast' : from \
                                 // data pointer 'void *' to function \
                                 // pointer
    #pragma warning(disable : 4152) // warning C4152: nonstandard       \
...
static void load_procs(void)
{
    ...
    gl3wTexParameterf                               = (PFNGLTEXPARAMETERFPROC)get_proc("glTexParameter"
                                                                                       "f");
    gl3wTexParameterfv                              = (PFNGLTEXPARAMETERFVPROC)get_proc("glTexParamete"
                                                                                        "rfv");
    gl3wTexParameteri                               = (PFNGLTEXPARAMETERIPROC)get_proc("glTexParameter"
                                                                                       "i");
    gl3wTexParameteriv                              = (PFNGLTEXPARAMETERIVPROC)get_proc("glTexParamete"
                                                                                        "riv");
    ...
    gl3wPolygonOffset                               = (PFNGLPOLYGONOFFSETPROC)get_proc("glPolygonOffse"
                                                                                       "t");
    gl3wCopyTexImage1D                              = (PFNGLCOPYTEXIMAGE1DPROC)get_proc("glCopyTexImag"
                                                                                        "e1D");
    gl3wCopyTexImage2D                              = (PFNGLCOPYTEXIMAGE2DPROC)get_proc("glCopyTexImag"
                                                                                        "e2D");
    ...
    gl3wTexSubImage1D                               = (PFNGLTEXSUBIMAGE1DPROC)get_proc("glTexSubImage1"
                                                                                       "D");
    gl3wTexSubImage2D                               = (PFNGLTEXSUBIMAGE2DPROC)get_proc("glTexSubImage2"
                                                                                       "D");
    gl3wBindTexture                                 = (PFNGLBINDTEXTUREPROC)get_proc("glBindTexture");
    gl3wDeleteTextures                              = (PFNGLDELETETEXTURESPROC)get_proc("glDeleteTextu"
                                                                                        "res");
    ...
    gl3wBlendEquation                               = (PFNGLBLENDEQUATIONPROC)get_proc("glBlendEquatio"
                                                                                       "n");
    ...
    gl3wTexSubImage3D                               = (PFNGLTEXSUBIMAGE3DPROC)get_proc("glTexSubImage3"
                                                                                       "D");
    gl3wCopyTexSubImage3D                           = (PFNGLCOPYTEXSUBIMAGE3DPROC)get_proc("glCopyTexSubImage3D");
    gl3wActiveTexture                               = (PFNGLACTIVETEXTUREPROC)get_proc("glActiveTextur"
                                                                                       "e");
    gl3wSampleCoverage                              = (PFNGLSAMPLECOVERAGEPROC)get_proc("glSampleCover"
                                                                                        "age");
    ...
    gl3wMultiDrawArrays                             = (PFNGLMULTIDRAWARRAYSPROC)get_proc("glMultiDraw"
                                                                                         "Arrays");
    gl3wMultiDrawElements                           = (PFNGLMULTIDRAWELEMENTSPROC)get_proc("glMultiDrawElements");
    gl3wPointParameterf                             = (PFNGLPOINTPARAMETERFPROC)get_proc("glPointPara"
                                                                                         "meterf");
    gl3wPointParameterfv                            = (PFNGLPOINTPARAMETERFVPROC)get_proc("glPointParameterfv");
    gl3wPointParameteri                             = (PFNGLPOINTPARAMETERIPROC)get_proc("glPointPara"
                                                                                         "meteri");
    ...
    gl3wDeleteQueries                               = (PFNGLDELETEQUERIESPROC)get_proc("glDeleteQuerie"
                                                                                       "s");
    ...
    gl3wDeleteBuffers                               = (PFNGLDELETEBUFFERSPROC)get_proc("glDeleteBuffer"
                                                                                       "s");
    ...
    gl3wBufferSubData                               = (PFNGLBUFFERSUBDATAPROC)get_proc("glBufferSubDat"
                                                                                       "a");
    ...
    gl3wCompileShader                               = (PFNGLCOMPILESHADERPROC)get_proc("glCompileShade"
                                                                                       "r");
    gl3wCreateProgram                               = (PFNGLCREATEPROGRAMPROC)get_proc("glCreateProgra"
                                                                                       "m");
    gl3wCreateShader                                = (PFNGLCREATESHADERPROC)get_proc("glCreateShader");
    gl3wDeleteProgram                               = (PFNGLDELETEPROGRAMPROC)get_proc("glDeleteProgra"
                                                                                       "m");
    ...
    gl3wGetActiveAttrib                             = (PFNGLGETACTIVEATTRIBPROC)get_proc("glGetActive"
                                                                                         "Attrib");
    ...
    gl3wGetShaderSource                             = (PFNGLGETSHADERSOURCEPROC)get_proc("glGetShader"
                                                                                         "Source");
    ...
    gl3wValidateProgram                             = (PFNGLVALIDATEPROGRAMPROC)get_proc("glValidateP"
                                                                                         "rogram");
    gl3wVertexAttrib1d                              = (PFNGLVERTEXATTRIB1DPROC)get_proc("glVertexAttri"
                                                                                        "b1d");
    gl3wVertexAttrib1dv                             = (PFNGLVERTEXATTRIB1DVPROC)get_proc("glVertexAtt"
                                                                                         "rib1dv");
    gl3wVertexAttrib1f                              = (PFNGLVERTEXATTRIB1FPROC)get_proc("glVertexAttri"
                                                                                        "b1f");
    gl3wVertexAttrib1fv                             = (PFNGLVERTEXATTRIB1FVPROC)get_proc("glVertexAtt"
                                                                                         "rib1fv");
    gl3wVertexAttrib1s                              = (PFNGLVERTEXATTRIB1SPROC)get_proc("glVertexAttri"
                                                                                        "b1s");
    gl3wVertexAttrib1sv                             = (PFNGLVERTEXATTRIB1SVPROC)get_proc("glVertexAtt"
                                                                                         "rib1sv");
    gl3wVertexAttrib2d                              = (PFNGLVERTEXATTRIB2DPROC)get_proc("glVertexAttri"
                                                                                        "b2d");
    gl3wVertexAttrib2dv                             = (PFNGLVERTEXATTRIB2DVPROC)get_proc("glVertexAtt"
                                                                                         "rib2dv");
    gl3wVertexAttrib2f                              = (PFNGLVERTEXATTRIB2FPROC)get_proc("glVertexAttri"
                                                                                        "b2f");
    gl3wVertexAttrib2fv                             = (PFNGLVERTEXATTRIB2FVPROC)get_proc("glVertexAtt"
                                                                                         "rib2fv");
    gl3wVertexAttrib2s                              = (PFNGLVERTEXATTRIB2SPROC)get_proc("glVertexAttri"
                                                                                        "b2s");
    gl3wVertexAttrib2sv                             = (PFNGLVERTEXATTRIB2SVPROC)get_proc("glVertexAtt"
                                                                                         "rib2sv");
    gl3wVertexAttrib3d                              = (PFNGLVERTEXATTRIB3DPROC)get_proc("glVertexAttri"
                                                                                        "b3d");
    gl3wVertexAttrib3dv                             = (PFNGLVERTEXATTRIB3DVPROC)get_proc("glVertexAtt"
                                                                                         "rib3dv");
    gl3wVertexAttrib3f                              = (PFNGLVERTEXATTRIB3FPROC)get_proc("glVertexAttri"
                                                                                        "b3f");
    gl3wVertexAttrib3fv                             = (PFNGLVERTEXATTRIB3FVPROC)get_proc("glVertexAtt"
                                                                                         "rib3fv");
    gl3wVertexAttrib3s                              = (PFNGLVERTEXATTRIB3SPROC)get_proc("glVertexAttri"
                                                                                        "b3s");
    gl3wVertexAttrib3sv                             = (PFNGLVERTEXATTRIB3SVPROC)get_proc("glVertexAtt"
                                                                                         "rib3sv");
    ...
    gl3wVertexAttrib4bv                             = (PFNGLVERTEXATTRIB4BVPROC)get_proc("glVertexAtt"
                                                                                         "rib4bv");
    gl3wVertexAttrib4d                              = (PFNGLVERTEXATTRIB4DPROC)get_proc("glVertexAttri"
                                                                                        "b4d");
    gl3wVertexAttrib4dv                             = (PFNGLVERTEXATTRIB4DVPROC)get_proc("glVertexAtt"
                                                                                         "rib4dv");
    gl3wVertexAttrib4f                              = (PFNGLVERTEXATTRIB4FPROC)get_proc("glVertexAttri"
                                                                                        "b4f");
    gl3wVertexAttrib4fv                             = (PFNGLVERTEXATTRIB4FVPROC)get_proc("glVertexAtt"
                                                                                         "rib4fv");
    gl3wVertexAttrib4iv                             = (PFNGLVERTEXATTRIB4IVPROC)get_proc("glVertexAtt"
                                                                                         "rib4iv");
    gl3wVertexAttrib4s                              = (PFNGLVERTEXATTRIB4SPROC)get_proc("glVertexAttri"
                                                                                        "b4s");
    gl3wVertexAttrib4sv                             = (PFNGLVERTEXATTRIB4SVPROC)get_proc("glVertexAtt"
                                                                                         "rib4sv");
    ...
    gl3wGetBooleani_v                               = (PFNGLGETBOOLEANI_VPROC)get_proc("glGetBooleani_"
                                                                                       "v");
    gl3wGetIntegeri_v                               = (PFNGLGETINTEGERI_VPROC)get_proc("glGetIntegeri_"
                                                                                       "v");
    ...
    gl3wBindBufferRange                             = (PFNGLBINDBUFFERRANGEPROC)get_proc("glBindBuffe"
                                                                                         "rRange");
    gl3wBindBufferBase                              = (PFNGLBINDBUFFERBASEPROC)get_proc("glBindBufferB"
                                                                                        "ase");
    ...
    gl3wVertexAttribI1i                             = (PFNGLVERTEXATTRIBI1IPROC)get_proc("glVertexAtt"
                                                                                         "ribI1i");
    gl3wVertexAttribI2i                             = (PFNGLVERTEXATTRIBI2IPROC)get_proc("glVertexAtt"
                                                                                         "ribI2i");
    gl3wVertexAttribI3i                             = (PFNGLVERTEXATTRIBI3IPROC)get_proc("glVertexAtt"
                                                                                         "ribI3i");
    gl3wVertexAttribI4i                             = (PFNGLVERTEXATTRIBI4IPROC)get_proc("glVertexAtt"
                                                                                         "ribI4i");
    ...
    gl3wGetUniformuiv                               = (PFNGLGETUNIFORMUIVPROC)get_proc("glGetUniformui"
                                                                                       "v");
    ...
    gl3wTexParameterIiv                             = (PFNGLTEXPARAMETERIIVPROC)get_proc("glTexParame"
                                                                                         "terIiv");
    ...
    gl3wClearBufferiv                               = (PFNGLCLEARBUFFERIVPROC)get_proc("glClearBufferi"
                                                                                       "v");
    gl3wClearBufferuiv                              = (PFNGLCLEARBUFFERUIVPROC)get_proc("glClearBuffer"
                                                                                        "uiv");
    gl3wClearBufferfv                               = (PFNGLCLEARBUFFERFVPROC)get_proc("glClearBufferf"
                                                                                       "v");
    gl3wClearBufferfi                               = (PFNGLCLEARBUFFERFIPROC)get_proc("glClearBufferf"
                                                                                       "i");
    ...
    gl3wGetInteger64i_v                             = (PFNGLGETINTEGER64I_VPROC)get_proc("glGetIntege"
                                                                                         "r64i_v");
    ...
    gl3wBlendEquationi                              = (PFNGLBLENDEQUATIONIPROC)get_proc("glBlendEquati"
                                                                                        "oni");
    ...
    gl3wIsRenderbuffer                              = (PFNGLISRENDERBUFFERPROC)get_proc("glIsRenderbuf"
                                                                                        "fer");
    ...
    gl3wIsFramebuffer                               = (PFNGLISFRAMEBUFFERPROC)get_proc("glIsFramebuffe"
                                                                                       "r");
    gl3wBindFramebuffer                             = (PFNGLBINDFRAMEBUFFERPROC)get_proc("glBindFrame"
                                                                                         "buffer");
    gl3wDeleteFramebuffers                          = (PFNGLDELETEFRAMEBUFFERSPROC)get_proc("glDeleteFramebuffers");
    gl3wGenFramebuffers                             = (PFNGLGENFRAMEBUFFERSPROC)get_proc("glGenFrameb"
                                                                                         "uffers");
    ...
    gl3wGenerateMipmap                              = (PFNGLGENERATEMIPMAPPROC)get_proc("glGenerateMip"
                                                                                        "map");
    gl3wBlitFramebuffer                             = (PFNGLBLITFRAMEBUFFERPROC)get_proc("glBlitFrame"
                                                                                         "buffer");
    ...
    gl3wMapBufferRange                              = (PFNGLMAPBUFFERRANGEPROC)get_proc("glMapBufferRa"
                                                                                        "nge");
    gl3wFlushMappedBufferRange                      = (PFNGLFLUSHMAPPEDBUFFERRANGEPROC)get_proc("glFlushMappedBufferRange");
    gl3wBindVertexArray                             = (PFNGLBINDVERTEXARRAYPROC)get_proc("glBindVerte"
                                                                                         "xArray");
    gl3wDeleteVertexArrays                          = (PFNGLDELETEVERTEXARRAYSPROC)get_proc("glDeleteVertexArrays");
    gl3wGenVertexArrays                             = (PFNGLGENVERTEXARRAYSPROC)get_proc("glGenVertex"
                                                                                         "Arrays");
    gl3wIsVertexArray                               = (PFNGLISVERTEXARRAYPROC)get_proc("glIsVertexArra"
                                                                                       "y");
    ...
    gl3wProvokingVertex                             = (PFNGLPROVOKINGVERTEXPROC)get_proc("glProvoking"
                                                                                         "Vertex");
    ...
    gl3wClientWaitSync                              = (PFNGLCLIENTWAITSYNCPROC)get_proc("glClientWaitS"
                                                                                        "ync");
    gl3wWaitSync                                    = (PFNGLWAITSYNCPROC)get_proc("glWaitSync");
    gl3wGetInteger64v                               = (PFNGLGETINTEGER64VPROC)get_proc("glGetInteger64"
                                                                                       "v");
    ...
    gl3wBlendFunciARB                               = (PFNGLBLENDFUNCIARBPROC)get_proc("glBlendFunciAR"
                                                                                       "B");
    ...
    gl3wNamedStringARB                              = (PFNGLNAMEDSTRINGARBPROC)get_proc("glNamedString"
                                                                                        "ARB");
    ...
    gl3wDeleteSamplers                              = (PFNGLDELETESAMPLERSPROC)get_proc("glDeleteSampl"
                                                                                        "ers");
    ...
    gl3wTexCoordP1uiv                               = (PFNGLTEXCOORDP1UIVPROC)get_proc("glTexCoordP1ui"
                                                                                       "v");
    gl3wTexCoordP2ui                                = (PFNGLTEXCOORDP2UIPROC)get_proc("glTexCoordP2ui");
    gl3wTexCoordP2uiv                               = (PFNGLTEXCOORDP2UIVPROC)get_proc("glTexCoordP2ui"
                                                                                       "v");
    gl3wTexCoordP3ui                                = (PFNGLTEXCOORDP3UIPROC)get_proc("glTexCoordP3ui");
    gl3wTexCoordP3uiv                               = (PFNGLTEXCOORDP3UIVPROC)get_proc("glTexCoordP3ui"
                                                                                       "v");
    gl3wTexCoordP4ui                                = (PFNGLTEXCOORDP4UIPROC)get_proc("glTexCoordP4ui");
    gl3wTexCoordP4uiv                               = (PFNGLTEXCOORDP4UIVPROC)get_proc("glTexCoordP4ui"
                                                                                       "v");
    ...
    gl3wPatchParameteri                             = (PFNGLPATCHPARAMETERIPROC)get_proc("glPatchPara"
                                                                                         "meteri");
    ...
    gl3wEndQueryIndexed                             = (PFNGLENDQUERYINDEXEDPROC)get_proc("glEndQueryI"
                                                                                         "ndexed");
    ...
    gl3wProgramBinary                               = (PFNGLPROGRAMBINARYPROC)get_proc("glProgramBinar"
                                                                                       "y");
    ...
    gl3wVertexAttribL1d                             = (PFNGLVERTEXATTRIBL1DPROC)get_proc("glVertexAtt"
                                                                                         "ribL1d");
    gl3wVertexAttribL2d                             = (PFNGLVERTEXATTRIBL2DPROC)get_proc("glVertexAtt"
                                                                                         "ribL2d");
    gl3wVertexAttribL3d                             = (PFNGLVERTEXATTRIBL3DPROC)get_proc("glVertexAtt"
                                                                                         "ribL3d");
    gl3wVertexAttribL4d                             = (PFNGLVERTEXATTRIBL4DPROC)get_proc("glVertexAtt"
                                                                                         "ribL4d");
    ...
    gl3wViewportArrayv                              = (PFNGLVIEWPORTARRAYVPROC)get_proc("glViewportArr"
                                                                                        "ayv");
    ...
    gl3wScissorArrayv                               = (PFNGLSCISSORARRAYVPROC)get_proc("glScissorArray"
                                                                                       "v");
    gl3wScissorIndexed                              = (PFNGLSCISSORINDEXEDPROC)get_proc("glScissorInde"
                                                                                        "xed");
    gl3wScissorIndexedv                             = (PFNGLSCISSORINDEXEDVPROC)get_proc("glScissorIn"
                                                                                         "dexedv");
    ...
    gl3wGetnTexImageARB                             = (PFNGLGETNTEXIMAGEARBPROC)get_proc("glGetnTexIm"
                                                                                         "ageARB");
    gl3wReadnPixelsARB                              = (PFNGLREADNPIXELSARBPROC)get_proc("glReadnPixels"
                                                                                        "ARB");
    ...
    gl3wMemoryBarrier                               = (PFNGLMEMORYBARRIERPROC)get_proc("glMemoryBarrie"
                                                                                       "r");
    ...
    gl3wPushDebugGroup                              = (PFNGLPUSHDEBUGGROUPPROC)get_proc("glPushDebugGr"
                                                                                        "oup");
    gl3wPopDebugGroup                               = (PFNGLPOPDEBUGGROUPPROC)get_proc("glPopDebugGrou"
                                                                                       "p");
    gl3wObjectLabel                                 = (PFNGLOBJECTLABELPROC)get_proc("glObjectLabel");
    gl3wGetObjectLabel                              = (PFNGLGETOBJECTLABELPROC)get_proc("glGetObjectLa"
                                                                                        "bel");
    gl3wObjectPtrLabel                              = (PFNGLOBJECTPTRLABELPROC)get_proc("glObjectPtrLa"
                                                                                        "bel");
    gl3wGetObjectPtrLabel                           = (PFNGLGETOBJECTPTRLABELPROC)get_proc("glGetObjectPtrLabel");
    gl3wClearBufferData                             = (PFNGLCLEARBUFFERDATAPROC)get_proc("glClearBuff"
                                                                                         "erData");
    ...
    gl3wDispatchCompute                             = (PFNGLDISPATCHCOMPUTEPROC)get_proc("glDispatchC"
                                                                                         "ompute");
    ...
    gl3wTexBufferRange                              = (PFNGLTEXBUFFERRANGEPROC)get_proc("glTexBufferRa"
                                                                                        "nge");
